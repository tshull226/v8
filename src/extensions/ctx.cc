...
void Ctx::Initialize(Handle<Object> target) {
  ...
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "destroy", Ctx::Destroy);
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "pushCurrent", Ctx::PushCurrent);
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "popCurrent", Ctx::PopCurrent);
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "setCurrent", Ctx::SetCurrent);
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "getCurrent", Ctx::GetCurrent);
  WEBCUDA_SET_PROTOTYPE_METHOD(constructor_template, "synchronize", Ctx::Synchronize);
